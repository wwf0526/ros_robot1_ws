...
class Imu1Listener(Node):
    def __init__(self):
        super().__init__('imu1_listener')
        self.declare_parameter('topic', '/imu1/data_raw')
        ...
        self.get_logger().info(f'Subscribed IMU1: {self.topic}')
    ...
    def imu_callback(self, msg: Imu):
        ...
        self.get_logger().info(
            f'IMU1 #{self.count} frame={msg.header.frame_id} '
